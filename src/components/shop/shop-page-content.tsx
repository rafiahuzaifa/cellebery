      ...
      <div className="flex items-start justify-between gap-4 pt-5">
        <div>
          ...
          <div className="mt-3 flex items-center gap-2 text-[10px] uppercase tracking-[0.14em] text-[#22d3ee]">
            <span>{isArabic ? product.categoryName.ar : product.categoryName.en}</span>
...
export function ShopPageContent({ products, categoryOptions }: { products: AdminProduct[]; categoryOptions: PublicCategoryOption[] }) {
  ...
  const activeFilter = categoryParam && categoryOptions.some((c) => c.slug === categoryParam) ? categoryParam : selectedFilter;
  const frequencyImage = categoryOptions.some((c) => c.slug === activeFilter)
