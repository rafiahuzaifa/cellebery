  ...
  return (
    <article className="group">
      <div className="relative aspect-[0.92] overflow-hidden bg-[#151a1c]">
        <div className="full-media absolute inset-0 opacity-75 transition duration-700 group-hover:opacity-100" style={{ backgroundImage: `linear-gradient(180deg, rgba(8,10,12,.06), rgba(8,10,12,.5)), url(${product.image})` }} />
      ...
      <div className="flex items-start justify-between gap-4 pt-5">
        <div><h2 className="text-lg font-semibold tracking-[-0.03em]">{product.name}</h2><p className="mt-1 text-xs text-white/45">{product.detail}</p><p className="mt-3 text-[10px] uppercase tracking-[0.14em] text-[#22d3ee]">{product.category} · {product.rating} ★</p></div>
