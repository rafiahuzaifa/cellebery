...
export type AdminProduct = {
  ...
  image: string;
  updatedAt: string;
  en: { name: string; shortDescription: string; description: string; seoTitle: string; seoDescription: string };
  ar: { name: string; shortDescription: string; description: string; seoTitle: string; seoDescription: string };
};
...
export const seedAdminProducts: AdminProduct[] = [
  ...
  },
  {
    ...
    ar: { name: "", shortDescription: "", description: "", seoTitle: "", seoDescription: "" },
  },
  {
    id: "travel-case",
    sku: "CEL-AC-CASE01",
    ...
    ar: { name: "حقيبة السفر من سيليبري", shortDescription: "حماية في كل رحلة.", description: "", seoTitle: "", seoDescription: "" },
  },
];
